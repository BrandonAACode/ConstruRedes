      ...
      <div className="container">
        <div className="row text-center text-md-start">
          ...
          <div className="col-md-4 mb-4">
            <h5 className="fw-bold">ConstruRedes</h5>
          ...
          <div className="col-md-4 mb-4">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-dark fs-4 me-4 footer-icon">
            <i className="bi bi-instagram"></i></a>
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-dark fs-4 footer-icon">
